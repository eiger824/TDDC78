...
void * blurf_x_wrapper(void * data)
{
    ...
    printf("[T%u] Calculating filter in the horizontal direction\n", id);
    pthread_mutex_unlock(&mutex);

    // Call the filter in the horizontal direction 
    blurfilter_x(xsize, ysize, image, radius, weights);
...
void * blurf_y_wrapper(void * data)
{
    ...
    pthread_mutex_lock(&mutex);
    printf("[T%u] Calculating filter in the vertical direction\n", id);
    pthread_mutex_unlock(&mutex);

    // Call the filter in the horizontal direction 
    blurfilter_y(xsize, ysize, image, radius, weights);
